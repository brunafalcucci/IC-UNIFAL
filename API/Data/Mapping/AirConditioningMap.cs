...
{
    public class AirConditioningMap : IEntityTypeConfiguration<AirConditioning>
    {
        public void Configure(EntityTypeBuilder<AirConditioning> builder)
        {
            builder.ToTable("AirConditioning");
            ...
            builder.Property(prop => prop.AirConditioningValue)
            ...
            builder.Property(prop => prop.Acclimatized)
